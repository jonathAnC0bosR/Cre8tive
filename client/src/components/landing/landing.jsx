    ...
    >
      <div className="grid grid-cols-1 lg:flex lg:flex-row lg:min-h-screen mb-5">
        <div className="lg:basis-1/3 text-center lg:p-28 p-0 z-[2]  ">
          <div className="mb-16">
            <h1 className="text-white text-2xl md:text-5xl lg:text-7xl fade-in">
              Let's get
            </h1>
            <div className="flex justify-center text-4xl md:text-7xl lg:text-9xl fade-in">
              <h1 className="text-white">Cre</h1>
              <h1 className="text-orange-500">8</h1>
              <h1 className="text-white">tive</h1>
            </div>
          </div>
          <p className="text-white  md:text-xl lg:text-2xl fade-in-txt">
        ...
        <img
          src={backimg}
          className="lg:w-2/3 mx-auto lg:absolute lg:right-0 lg:top-0 z-[1] fade-in"
        ></img>
      </div>
      ...
      <div className=" md:-mt-28 lg:-mt-0 -mt-20  bg-zinc-950 mb-[2.5%] p-6 w-4/5 rounded-lg text-white shadow-xl shadow-stone-950 z-[1]">
        ...
        <div className="flex ">
          ...
          <p className="p-[2%]">
            Discover the simplicity of our platform: just post the job you need
            assistance with from an artist, and in return, list the skill or
      ...
      <div className="flex bg-zinc-950 mb-[2.5%] p-6 w-4/5 rounded-lg text-white  grid grid-cols-2 shadow-xl shadow-stone-950">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="p-[2%] w-3/4 ">
            Benefit from free interactions, elevate your projects, and embrace
            the freedom of job interchange.{" "}
          </p>
        </div>
        <div className="">
          <h1 className="text-xl lg:text-center md:text-1xl lg:text-2xl m-[1%]">
          ...
          <p className="p-[2%]">
            Unlocking artistry and fostering a collaborative economy, our
            platform unites individuals to share skills, services, and expertise
