                                ...
                                <Button.Group className="flex justify-center items-center bg-353434 min-w-fit">
                                    {skills.map(skill => (
                                        <Button
                                            ...
                                            className={selectedSkillNeededID === skill._id ? 'bg-pink-important' : 'bg-gray-important'}
                                        >
                                ...
                                <Button.Group className="flex justify-center items-center bg-353434 min-w-fit">
                                    {skills.map(skill => (
                                        <Button
                                            ...
                                            title={skill.skillTitle}
                                            className={selectedSkillOfferedID === skill._id ? 'bg-pink-important' : 'bg-gray-important'}
                                        >
                                            {getIconForSkill(skill.skillTitle)}
                                            {/* <p>{skill.skillTitle}</p> */}
                                        </Button>
