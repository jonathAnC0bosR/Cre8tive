...
const Profile = () => {
  ...
  return (
    <div
      id="profile div"
      className="pt-[70px] bg-gradient-to-r from-[#0C0F11] to-[#22282D]"
    >
      <div className="mainContainer">
        ...
        <div className="profileContainer flex items-center justify-center ">
          ...
          <div className="profileInfo flex flex-col items-center justify-center my-5">
            <h1> {username} </h1>
            <p className="mb-7 text-orange-500 font-bold">
              {" "}
              {userData.occupation}{" "}
            </p>
            <Link to='/editProfile'>
              {" "}
              <button className="bg-white text-orange-500 font-bold rounded-full py-1 px-2 text-sm">
                Edit Profile{" "}
              </button>
            </Link>
            ...
            <div
              className=" items-center justify-center m-5 w-1/2 p-4
          ...
          <div className="portfolioContainer">
            <h3>Portfolio</h3>
            <div
              className="firtsRowMedia"
              style={{ display: "flex", justifyContent: "center" }}
            >
              <PinterestEmbed
                url="https://www.pinterest.com.mx/pin/9570217950888311/"
                width={200}
                height={200}
              />
              <PinterestEmbed
                url="https://www.pinterest.com.mx/pin/670895675752727009/"
                width={200}
                height={200}
              />
              <PinterestEmbed
                url="https://www.pinterest.com.mx/pin/612067405622271768/"
                width={200}
                height={200}
              />
              <PinterestEmbed
                url="https://www.pinterest.com.mx/pin/654007177161332170/"
                width={200}
                height={200}
              />
            </div>
            <div
              className="secondsRowMedia"
              style={{ display: "flex", justifyContent: "center" }}
            >
              <PinterestEmbed
                url="https://www.pinterest.com.mx/pin/55732114131342304/"
                width={200}
                height={200}
              />
              <PinterestEmbed
