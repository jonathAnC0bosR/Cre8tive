          ...
          <div className="flex overflow-x-scroll custom-scrollbar">
            <div className="flex flex-col mb-5">
              ...
              <div className="relative rounded-b-lg w-80 overflow-hidden relative ">
                ...
                <div className="absolute inset-0 bg-[url('assets/images/Photo.png')] bg-cover bg-center filter blur-xs shadow-inner shadow"></div>                {/* Content */}
                <ActiveJobsCard />
              </div>
            </div>
          </div>
                ...
                <div className="relative rounded-b-lg w-80 overflow-hidden relative ">
                  ...
                  {/* <div className="flex flex-row gap-8 mx-auto justify-center text-center">
                    ...
                    <div className="flex m-2 items-center justify-center gap-8 mx-auto bg-white rounded-full " >
                      <div>
                        <h3 className="text-pink-600 text-lg font-bold mb-1">Needs</h3>
                      </div>
                      <div>
                        {post.serviceNeed && post.serviceNeed.length > 0 && (
                          <p className="text-lg font-bold " >{post.serviceNeed[0].skillTitle}</p>
                        )}
                      </div>
                    ...
                    <div className="flex m-2 items-center justify-center gap-8 mx-auto bg-white rounded-full " >
                      <div>
                        <h3 className="text-pink-600 font-bold text-lg mb-1 ">Offers</h3>
                      </div>
                      <div>
                        {post.serviceNeed && post.serviceNeed.length > 0 && (
                          <p className="text-lg font-bold " >{post.serviceOffer[0].skillTitle}</p>
                        )}
                      </div>
