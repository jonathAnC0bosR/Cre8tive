          ...
          <div className="rounded-xl p-5 m-4 border-2 border-gray-300	 ">
            ...
            >
              ...
              <div className="basis-1/3 flex items-center justify-center ">
                <select
                  id="drop1"
                  className="rounded-full text-pink-600 font-bold px-12
              border border-pink-600 focus:ring-2 focus:ring-df4088 focus:border-transparent"
                >
                  <option value="offer" className="text-center">
                    Offers
                  </option>
                  <option value="need" className="text-center">
                    Needs
                  </option>
                </select>
              </div>
              ...
              <div className="basis-1/3 flex items-center justify-center ">
                <select
                  id="skills"
                  className="rounded-full text-pink-600 font-bold
              border border-pink-600 focus:ring-2 focus:ring-df4088 focus:border-transparent"
                >
                  <option value="UI/UX" className="text-center">
                    UI/UX
                  </option>
                  <option value="Illustration" className="text-center">
                    Illustration
                  </option>
                  <option value="Photo" className="text-center">
                    Photo
                  </option>
                  <option value="Graphic Design" className="text-center">
                    Graphic Design
                  </option>
                  <option value="3D Design" className="text-center">
                    3D Design
                  </option>
                </select>
              </div>
          ...
          {searchType[0] === "offer" ? (
            <div>
              <div className="flex items-center ml-28 mt-10  mb-6 gap-2">
                ...
                <h2 className="text-white text-xl font-bold">Posts that</h2>
            ...
            <div className="flex h-[50vh] flex-col items-center justify-center">
              <h1 className="text-orange-500 text-5xl mb-4 text-center  ">
                Explore job posts by skill!
              </h1>
              <h2 className="text-lg text-white mb-5">
                In this page you can try filter job posts by Need or Offer.
              </h2>
