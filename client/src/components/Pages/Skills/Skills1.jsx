...
const Skills = () => {
  ...
  const skills = [
    ...
    { name: "UI/UX", value: "3" },
    { name: "Graphic Design", value: "4" },
    { name: "3D Design", value: "2" },
  ];
    ...
    <div className=" lg:text-sm min-h-screen bg-gradient-to-r from-[#0C0F11] to-[#22282D] flex flex-col">
      <div className="pt-20">
        ...
        <div className="	  mx-5 rounded  p-4">
          ...
          <div className="rounded-xl p-5 m-4 border-2 border-gray-300	 ">
            <form className="flex flex-row ">
                ...
                <button
                  className={`${
                    selectedButton === 2
                      ? "bg-df4088 text-white"
                      : "bg-gray-200 text-df4088 "
                  } py-2 px-4 mx-2 rounded-full moving-bar-skills`}
              ...
              <button className=" text-pink-600 font-bold bg-white h-10  mx-auto w-32 rounded-full">
                Create Post!
              </button>
            </form>
          </div>
        ...
        <div className="flex items-center m-16 gap-2">
          ...
          <h2 className="text-white text-xl font-bold">Photography</h2>
        </div>
        ...
        <div className="flex flex-col p-8 rounded-lg mx-4 sm:m-4 md:mt-0 md:mb-5 md:mx-12">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center mb-4 gap-2">
              ...
              <h2 className="text-white text-xl font-bold">Illustration</h2>
            </div>
            {/* Here the cards get stored */}
            <div className="flex overflow-x-scroll custom-scrollbar">
              <div className="flex flex-col mb-5">
          ...
          <div className="mb-8">
            <div className="flex items-center mb-4 gap-2">
              ...
              <h2 className="text-white text-xl font-bold">3D Design</h2>
            </div>
            {/* Here the cards get stored */}
            <div className="flex overflow-x-scroll custom-scrollbar">
              <div className="flex flex-col mb-5">
          ...
          <div className="mb-8">
            <div className="flex items-center mb-4 gap-2">
              ...
              <h2 className="text-white text-xl font-bold">Graphic Design</h2>
            </div>
            {/* Here the cards get stored */}
            <div className="flex overflow-x-scroll custom-scrollbar">
              <div className="flex flex-col mb-5">
